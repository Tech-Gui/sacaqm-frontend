    ...
    try {
      ...
      setDashData({
        ...
        table: [
          ...
          { parameter: "CO2",   status: statuses.co2,   exceedances: curr.filter((d) => (d.co2         || 0) > THRESHOLDS.co2).length },
  ...
  return (
    <Box sx={{
      ...
      <Container maxWidth="xl">
        ...
        {!loading && dashData && (
          <>
            {/* ROW 1: Compliance Summary & Table - AT TOP */}
            <Grid container spacing={3} sx={{ mb: 3 }}>
              <Grid item xs={12} md={4}>
                <Box sx={fadeIn(0)}>
