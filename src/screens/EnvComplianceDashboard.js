...
const THRESHOLDS = { 
  pm1: 40,      // No official standard — keeping estimated value
  pm25: 103,    // PM2.5: 103 µg/m³ (hourly) - SAAQIS Band 3→4 transition
  pm5: 60,      // No official standard — keeping estimated value  
  pm10: 190,    // PM10: 190 µg/m³ (hourly) - SAAQIS Band 3→4 transition
  noise: 70,    // dB — not in SAAQIS, keeping occupational health standard
  temperature: 32, // °C — not in SAAQIS, keeping comfort standard
  humidity: 80,    // % — not in SAAQIS, keeping comfort standard
  co2: 1000,       // ppm — not in SAAQIS, keeping indoor air quality standard
  nox: 106,        // NO2: 106 ppb (hourly) - SAAQIS Band 3→4 transition (unchanged)
  voc: 500         // No official SAAQIS standard — keeping indoor air quality guideline
};
// ─── Styles ───────────────────────────────────────────────────────────────────
const filterBarSx = {
