...
//   // In forecast mode: cap to exactly 7 days, relabel with forecast dates
//   const buckets      = isForecast ? allBuckets.slice(-7) : allBuckets;
//   const rawLabels    = buckets.map(b => b.label);
//   const rawValues    = buckets;
//   const labels       = isForecast && forecastWeekLabels.length > 0
//     ? forecastWeekLabels.slice(0, buckets.length)
//     : rawLabels;
