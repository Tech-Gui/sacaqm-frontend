...
//     const greenAngle = startAngle + (Math.PI * greenPercent);
//     const amberAngle = startAngle + (Math.PI * amberPercent);

//     console.log('🎯 Noise Gauge:', {
//       value: `${value}dB`,
//       expectedZone: value <= 55 ? 'GREEN' : value <= 70 ? 'AMBER' : 'RED',
//       needleAngle: `${((value/100)*180).toFixed(1)}°`,
//       greenZone: `0-99°`,
//       amberZone: `99-126°`,
//       redZone: `126-180°`
//     });
...
//     ctx.fillText('50', centerX, centerY - radius + 20);
//     ctx.fillText('100', centerX + radius + 10, centerY + 5);

//     // NEEDLE
//     const safeValue = Math.min(Math.max(value, 0), thresholds.red);
//     const needleAngle = startAngle + (Math.PI * safeValue / thresholds.red);
